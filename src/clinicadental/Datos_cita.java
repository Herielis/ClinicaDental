 ...
 * @author tajib
 */
public class Datos_cita extends javax.swing.JFrame {

    /**
     * Creates new form Datos_cita
     */
    public Datos_cita() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("*NOMBRE COMPLETO DEL PACIENTE*");
        ...
        jButton3.setText("Datos del Paciente");

        jButton4.setBackground(new java.awt.Color(102, 255, 255));
        jButton4.setText("Fecha de Cita");
        ...
        jLabel4.setText("*FOTO DEL PACIENTE*");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Datos_cita.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Datos_cita().setVisible(true);
            }
        });
    }
